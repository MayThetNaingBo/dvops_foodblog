...
app.use(Sentry.Handlers.requestHandler); // Updated
...
const addPostRateLimiter = rateLimit({
    ...
    message: {
        success: false,
        message: "You have exceeded the maximum limit of 3 posts within 3 minutes. Please wait before posting again.",
    },
});
